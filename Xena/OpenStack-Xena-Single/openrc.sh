##--------------------system Config--------------------##
##Controller/Compute Server Manager IP. example:x.x.x.x
HOST_IP=

##Externel IPv4 for dashboard. example 192.168.11.1, maybe as same with HOST_IP
FLOATING_IP=

##Controller/Compute Server hostname. example:controller
HOST_NAME=
